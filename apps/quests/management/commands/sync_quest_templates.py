...
DEFAULT_TEMPLATES = [
    ...
    },
    {
        ...
        "code": "weekly-report",
        "title": "Итоги недели",
        "description": "Расскажи, что сделал за неделю, и приложи подтверждение (проверка куратором).",
        "quest_type": QuestType.WEEKLY,
        "verifier": QuestVerifierKind.MANUAL,
        "verifier_params": {},
        "reward_coins": 15,
    ...
    {
        "code": "self-report-practice",
        "title": "Дневник практики",
        "description": "Заполни дневник производственной практики и приложи ссылку (проверка куратором).",
        "quest_type": QuestType.SELF_REPORT,
        "verifier": QuestVerifierKind.MANUAL,
        "verifier_params": {},
        "reward_coins": 25,
    ...
    {
        "code": "self-report-demo",
        "title": "Защита проекта",
        "description": "Выступи с защитой проекта или доклада, приложи материалы (проверка куратором).",
        "quest_type": QuestType.SELF_REPORT,
        "verifier": QuestVerifierKind.MANUAL,
        "verifier_params": {},
        "reward_coins": 40,
    ...
    {
        "code": "self-report-hackathon",
        "title": "Хакатон или олимпиада",
        "description": "Прими участие в хакатоне или олимпиаде, приложи подтверждение (проверка куратором).",
        "quest_type": QuestType.SELF_REPORT,
        "verifier": QuestVerifierKind.MANUAL,
        "verifier_params": {},
        "reward_coins": 40,
    ...
    {
        "code": "self-report-volunteer",
        "title": "Волонтёрство",
        "description": "Помоги на мероприятии колледжа, приложи подтверждение (проверка куратором).",
        "quest_type": QuestType.SELF_REPORT,
        "verifier": QuestVerifierKind.MANUAL,
        "verifier_params": {},
        "reward_coins": 25,
    ...
    {
        "code": "self-report-help",
        "title": "Помощь однокурснику",
        "description": "Разобрал тему с сокурсником или помог младшему курсу (проверка куратором).",
        "quest_type": QuestType.SELF_REPORT,
        "verifier": QuestVerifierKind.MANUAL,
        "verifier_params": {},
        "reward_coins": 15,
    ...
    {
        "code": "self-report-opensource",
        "title": "Вклад в проект",
        "description": "Закрытая задача в учебном или открытом репозитории: приложи ссылку на коммит.",
        "quest_type": QuestType.SELF_REPORT,
        "verifier": QuestVerifierKind.MANUAL,
        "verifier_params": {},
        "reward_coins": 20,
